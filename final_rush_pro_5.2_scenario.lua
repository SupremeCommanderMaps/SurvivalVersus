...
Version of the 5 adds several new features and fixes many bugs. For more information, see the README.md (text file) located in "Maps/final_rush_pro_5.2.v0002", or visit the site at https://github.com/JeroenDeDauw/FinalRushPro5]],
    ...
    norushradius=110,
    map="/maps/final_rush_pro_5.2.v0002/final_rush_pro_5.2.scmap",
    preview="/maps/final_rush_pro_5.2.v0002/preview.jpg",
    save="/maps/final_rush_pro_5.2.v0002/final_rush_pro_5.2_save.lua",
    script="/maps/final_rush_pro_5.2.v0002/final_rush_pro_5.2_script.lua",
    size={ 512, 512 },
    starts=true,
    type="skirmish",
    Configurations={
