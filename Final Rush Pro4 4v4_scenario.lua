...
ScenarioInfo = {
  ...
  map="/maps/Final Rush Pro4 4v4.v0007/Final Rush Pro4 4v4.scmap",
  map_version=7,
  name="Final Rush Pro4 4v4",
  ...
  norushradius=110,
  preview="/maps/Final Rush Pro4 4v4.v0007/preview.jpg",
  save="/maps/Final Rush Pro4 4v4.v0007/Final Rush Pro4 4v4_save.lua",
  script="/maps/Final Rush Pro4 4v4.v0007/Final Rush Pro4 4v4_script.lua",
  size={ 512, 512 },
  starts=true,
  type="skirmish"
}
