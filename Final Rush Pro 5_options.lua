options =
{
    ...
    },
    {
        ...
        values = {
            { text = "Difficulty preset", help = "Automatically pick a value based on the selected difficulty", key = -1, },
            { text = "None", help = "None", key = 0, },
            { text = "10 percent", help = "10 percent for every 100 seconds", key = 10, },
            { text = "20 percent", help = "20 percent for every 100 seconds", key = 20, },
            { text = "25 percent", help = "25 percent for every 100 seconds", key = 25, },
            { text = "30 percent", help = "30 percent for every 100 seconds", key = 20, },
            { text = "50 percent", help = "50 percent for every 100 seconds", key = 50, },
            { text = "100 percent", help = "100 percent for every 100 seconds", key = 100, },
            { text = "200 percent", help = "200 percent for every 100 seconds", key = 200, },
            { text = "300 percent", help = "300 percent for every 100 seconds", key = 300, },
            { text = "400 percent", help = "400 percent for every 100 seconds", key = 400, },
            { text = "500 percent", help = "500 percent for every 100 seconds", key = 500, },
            { text = "1000 percent", help = "1000 percent for every 100 seconds", key = 1000, },
        },
    },
    {
        default = 1,
