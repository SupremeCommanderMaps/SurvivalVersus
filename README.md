...
of their `final_rush_pro_5.v0020` in `Documents\My Games\Gas Powered Games\Supreme Commander Forged Alliance\Maps`.
...
* Extract the zip. The result should be a directory named `final_rush_pro_5.v0020`
