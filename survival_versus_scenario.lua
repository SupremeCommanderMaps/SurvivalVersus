...
ScenarioInfo = {
    ...
    norushradius=110,
    map="/maps/survival_versus.v0024/survival_versus.scmap",
    preview="/maps/survival_versus.v0024/preview.jpg",
    save="/maps/survival_versus.v0024/survival_versus_save.lua",
    script="/maps/survival_versus.v0024/survival_versus_script.lua",
    size={ 512, 512 },
    starts=true,
    type="skirmish",
    Configurations={
