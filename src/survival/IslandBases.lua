newInstance = function()
    local spawnerClass = import('/maps/final_rush_pro_5.v0015/src/lib/BaseSpanwer.lua')
    local unitModifier = import('/maps/final_rush_pro_5.v0015/src/lib/CapturableUnitModifier.lua').newInstance()
