newInstance = function()
    local spawnerClass = import('/maps/final_rush_pro_5.v0021/vendor/lib/src/BaseSpanwer.lua')
    local unitModifier = import('/maps/final_rush_pro_5.v0021/vendor/lib/src/CapturableUnitModifier.lua').newInstance()
