newInstance = function()
    local spawnerClass = import('/maps/survival_versus.v0025/vendor/EntropyLib/src/BaseSpanwer.lua')
    local unitModifier = import('/maps/survival_versus.v0025/vendor/EntropyLib/src/CapturableUnitModifier.lua').newInstance()
