newInstance = function()
    local spawnerClass = import('/maps/survival_versus.v0026/vendor/EntropyLib/src/BaseSpanwer.lua')
    local unitModifier = import('/maps/survival_versus.v0026/vendor/EntropyLib/src/CapturableUnitModifier.lua').newInstance()
    ...
    local function spawnCentralMex(baseSpawner)
        ...
        unitModifier.modify(
            ...
            function(unit)
                ...
                unit:SetProductionPerSecondMass(42)
                unit:SetCustomName("Capture for 42 mass/s")
            end
        )
