newInstance = function()
    local spawnerClass = import('/maps/final_rush_pro_5.v0022/vendor/EntropyLib/src/BaseSpanwer.lua')
    local unitModifier = import('/maps/final_rush_pro_5.v0022/vendor/EntropyLib/src/CapturableUnitModifier.lua').newInstance()
