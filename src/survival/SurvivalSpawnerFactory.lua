newInstance = function(options, ScenarioFramework, unitCreator, playerArmies, positions,
    ...
    local transportSpawnerClass = import('/maps/survival_versus.v0025/src/survival/SurvivalTransportSpawner.lua')
    local unitSpawnerClass = import('/maps/survival_versus.v0025/src/survival/SurvivalUnitSpawner.lua')
