newInstance = function(options, ScenarioFramework, unitCreator, playerArmies, getRandomPlayer,
    ...
    local transportSpawnerClass = import('/maps/final_rush_pro_5.v0016/src/survival/SurvivalTransportSpawner.lua')
    local unitSpawnerClass = import('/maps/final_rush_pro_5.v0016/src/survival/SurvivalUnitSpawner.lua')
