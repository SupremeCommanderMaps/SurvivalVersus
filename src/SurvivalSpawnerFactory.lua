newInstance = function(options, ScenarioFramework, unitCreator, playerArmies, getRandomPlayer,
    ...
    local transportSpawnerClass = import('/maps/final_rush_pro_5.8.v0001/src/SurvivalTransportSpawner.lua')
    local unitSpawnerClass = import('/maps/final_rush_pro_5.8.v0001/src/SurvivalUnitSpawner.lua')
