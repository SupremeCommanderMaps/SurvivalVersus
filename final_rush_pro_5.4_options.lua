options =
{
    ...
    },
    {
        default = 1,
        label = "Team Bonus",
        help = "Affects both survival modes. Make it easier for one team to improve balance. The percentage is applied as bonus to the auto reclaim and health increase options for the selected team. If the auto reclaim setting is 50 percent and the bonus is 50, the team will get 75 percent. If the HP increase is 20 percent and the bonus is 50 percent, it will be only 10 percent for this team.",
        key = 'opt_FinalRushTeamBonus',
        pref = 'opt_FinalRushTeamBonus',
        values = {
            { text = "None", help = "None", key = 0 },
            { text = "Top team, 2 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 2 },
            { text = "Top team, 5 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 5 },
            { text = "Top team, 10 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 10 },
            { text = "Top team, 15 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 15 },
            { text = "Top team, 20 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 20 },
            { text = "Top team, 30 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 30 },
            { text = "Top team, 50 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 50 },
            { text = "Top team, 75 percent", help = "The top team gets more auto reclaim and a lower HP increase for enemy units", key = 75 },
            { text = "Bottom team, 2 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -2 },
            { text = "Bottom team, 5 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -5 },
            { text = "Bottom team, 10 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -10 },
            { text = "Bottom team, 15 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -15 },
            { text = "Bottom team, 20 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -20 },
            { text = "Bottom team, 30 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -30 },
            { text = "Bottom team, 50 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -50 },
            { text = "Bottom team, 75 percent", help = "The bottom team gets more auto reclaim and a lower HP increase for enemy units", key = -75 },
        },
    },
    {
        default = 8,
