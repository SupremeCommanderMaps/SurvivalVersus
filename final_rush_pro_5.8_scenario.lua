...
Version of the 5 adds several new features and fixes many bugs. For more information, see the README.md (text file) located in "Maps/final_rush_pro_5.7.v0001", or visit the site at https://github.com/JeroenDeDauw/FinalRushPro5]],
